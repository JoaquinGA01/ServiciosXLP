...
// Generado el: 2022.06.02 a las 01:39:41 AM CDT 
//
...
public class ModificarEventoRequest {
    ...
    protected List<ModificarEventoRequest.Evento> evento;
     ...
     * {@link ModificarEventoRequest.Evento }
     * 
     * 
     */
    public List<ModificarEventoRequest.Evento> getEvento() {
        if (evento == null) {
            evento = new ArrayList<ModificarEventoRequest.Evento>();
        }
        return this.evento;
    }
